    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            final Map<String, Object> criteria =
                QuickSearch.getCriteria(version, experimentMetaClass, params);
            ...
            final ExperimentReport report =
                new ExperimentReport(version, criteria1, (String) criteria.get("search_all"), start, end);
            final String[] bookHooks = request.getParameterValues(SearchExperiment._LAB_NOTEBOOKS);
            ...
            request.setAttribute("experiments",
                SearchExperiment.getExperimentBeans(report.getResults(paging)));
