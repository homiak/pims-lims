...
public class RecordLink extends PIMSTag {
        ...
        RecordLink.FORMATTERS.put(Target.class.getName(), new LinkFormatter("types/target.gif") {
            ...
            public String getExtraLinks(final String hook, final String path) {
                return RecordLink.makeMenuItem("/Graph/" + hook, "actions/viewdiagram.gif", "View diagram",
                    ...
                    + RecordLink.makeMenuItem("/spot/CreateExpressionObjective/" + hook + "?wizard_step=1",
    ...
    public int doStartTag() throws JspException {
        ...
        html.append("<img class=\"linkicon\" src=\"").append(path).append("/images/icons/")
            .append(formatter.getIcon()).append("\" alt=\"").append(displayName).append("\" title=\"")
            .append(displayName).append("\" />");
        html.append("<a href=\"").append(path).append("/View/").append(hook).append("\">").append(name)
            .append("</a>");
        html.append("<img src=\"" + path + "/images/icons/pulldown.gif\" alt=\"\" ")
            .append("onclick=\"old_showContextMenu(this,[").append(menuItems).append("])\" ")
            .append("class=\"linkicon\" />");
        html.append("</span>");
        try {
